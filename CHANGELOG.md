...
- Dynamic viewing distance tracking, customized framerate and target .
...
- `paused` status recorder can be access beyond WebGazer.
...
- `predicting` status recorder of WebGazer.
