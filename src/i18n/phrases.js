...
export const remoteCalibratorPhrases = {
  ...
  RC_distanceTrackingGuide: {
    ...
    hr: 'Vaše su oči udaljene xx1 cm od ekrana, ali za eksperiment je potrebno približno xx2 cm. Eksperiment će se nastaviti kada dosegnete točnu udaljenost.',
    ...
    he: 'העיניים שלך מרוחקות xx1 ס"מ מהמסך, אבל הניסוי צריך בערך xx2 ס"מ. הניסוי יתחדש כאשר תגיע למרחק הנכון.',
    ...
    ms: 'Mata anda adalah xx1 cm dari skrin, tetapi percubaan memerlukan kira-kira xx2 cm. Percubaan akan disambung semula apabila anda mencapai jarak yang betul.',
    ...
    ur: 'آپ کی آنکھیں اسکرین سے xx1 سینٹی میٹر کی دوری پر ہیں، لیکن تجربے کے لیے تقریباً xx2 سینٹی میٹر کی ضرورت ہے۔ جب آپ صحیح فاصلے پر پہنچ جائیں گے تو تجربہ دوبارہ شروع ہو جائے گا۔',
  },
  ...
  RC_canUsePhoneKeypad: {
    'en-US': 'You can use the keypad on your phone to respond.',
    ar: '#PAUSED!',
    hy: '«Միացումը աշխատում է! Հիմա փակում եմ։ Շնորհակալություն»։',
    bg: 'Можете да използвате клавиатурата на телефона си, за да отговорите.',
    'zh-CN': '连接成功！现在关闭。谢谢。',
    'zh-HK': '您可以使用手機上的鍵盤回覆。',
    hr: 'Za odgovor možete koristiti tipkovnicu na telefonu.',
    cs: 'K odpovědi můžete použít klávesnici na telefonu.',
    da: 'Du kan bruge tastaturet på din telefon til at svare.',
    nl: 'U kunt het toetsenbord van uw telefoon gebruiken om te reageren.',
    'en-UK': 'You can use the keypad on your phone to respond.',
    fi: 'Voit käyttää puhelimesi näppäimistöä vastataksesi.',
    fr: '#PAUSED!',
    de: 'Sie können zum Antworten die Tastatur Ihres Telefons verwenden.',
    el: 'Μπορείτε να χρησιμοποιήσετε το πληκτρολόγιο του τηλεφώνου σας για να απαντήσετε.',
    he: 'אתה יכול להשתמש בלוח המקשים בטלפון שלך כדי להגיב.',
    hi: 'आप उत्तर देने के लिए अपने फ़ोन पर कीपैड का उपयोग कर सकते हैं.',
    hu: 'Válaszolásához használhatja a telefon billentyűzetét.',
    is: 'Þú getur notað takkaborð símans til að svara.',
    id: 'Anda dapat menggunakan papan tombol di ponsel Anda untuk merespons.',
    it: '#PAUSED!',
    ja: '電話機のキーパッドを使用して応答できます。',
    kn: 'ಪ್ರತಿಕ್ರಿಯಿಸಲು ನಿಮ್ಮ ಫೋನ್‌ನಲ್ಲಿರುವ ಕೀಪ್ಯಾಡ್ ಅನ್ನು ನೀವು ಬಳಸಬಹುದು.',
    ko: '휴대폰의 키패드를 사용하여 응답할 수 있습니다.',
    lt: 'Ryšys veikia! Dabar uždaroma. Ačiū.',
    ms: 'Anda boleh menggunakan pad kekunci pada telefon anda untuk bertindak balas.',
    ...
    pl: 'Aby odpowiedzieć, możesz użyć klawiatury telefonu.',
    ...
    tl: 'Maaari mong gamitin ang keypad sa iyong telepono upang tumugon.',
    tr: 'Yanıt vermek için telefonunuzun tuş takımını kullanabilirsiniz.',
    ur: 'آپ جواب دینے کے لیے اپنے فون پر کی پیڈ استعمال کر سکتے ہیں۔',
  },
  ...
  RC_errorCameraUseDenied: {
    ...
    is: 'Eins og fram kemur í lýsingunni er þessi rannsókn ósamrýmanleg ooo og þarf að BBB vafra keyrir á DDD með að minnsta kosti 222 CPU kjarna',
    ...
    su: 'Sakumaha anu dinyatakeun dina pedaranana, ulikan ieu teu cocog sareng ooo, sareng peryogi browser BBB anu dijalankeun dina DDD kalayan sahenteuna 222 inti CPU.',
  ...
  RC_errorNoCamera: {
    ...
    hu: 'Ehhez a tanulmányhoz webkamerát kell használni. A webkamerához való hozzáférés megadása nem kötelező, de enélkül nem tudjuk folytatni. Ha tévedésből nemet mondott, és most hozzáférést szeretne adni nekünk a kamerájához, keresse meg a kamera ikont a címsorban, kattintson rá, engedélyezze a kamera elérését, és frissítse az oldalt.',
    ...
    ko: '이 연구에서는 웹캠을 사용해야 합니다. 웹캠에 대한 액세스 권한을 부여하는 것은 선택 사항이지만, 웹캠 없이는 계속할 수 없습니다. 실수로 아니요라고 답했고 이제 카메라에 대한 액세스 권한을 부여하려면 주소 표시줄에서 카메라 아이콘을 찾아 클릭한 후 카메라 액세스를 허용하고 페이지를 새로 고치세요.',
    ...
    sw: 'Utafiti huu unahitaji kutumia kamera ya wavuti. Kutoa ufikiaji kwa kamera yako ya wavuti ni hiari, lakini hatuwezi kuendelea bila hiyo. Ikiwa ulisema Hapana kimakosa na sasa ungependa kutupa ufikiaji wa kamera yako, tafadhali tafuta aikoni ya kamera kwenye upau wa anwani, uibofye, ruhusu ufikiaji wa kamera, na uonyeshe ukurasa upya.',
    sv: 'Denna studie behöver använda webbkameran. Att ge åtkomst till din webbkamera är valfritt, men vi kan inte fortsätta utan den. Om du sa nej av misstag och nu vill ge oss åtkomst till din kamera, hitta kameraikonen i adressfältet, klicka på den, tillåt kameraåtkomst och uppdatera sidan.',
    ...
    tr: 'Bu çalışmada web kamerasının kullanılması gerekiyor. Web kameranıza erişim izni vermek isteğe bağlıdır ancak onsuz devam edemeyiz. Yanlışlıkla Hayır dediyseniz ve şimdi kameranıza erişmemize izin vermek istiyorsanız, lütfen adres çubuğundaki kamera simgesini bulun, tıklayın, kamera erişimine izin verin ve sayfayı yenileyin.',
  ...
  RC_gazeTrackingNudge: {
    ...
    hy: 'ԲՌՆԵՔ ԽԱՉԸ: Մենք քո օգնության կարիքը ունենք։ Աչքի հետագծողին ավելի շատ մարզում է հարկավոր: Ինչպես ցույց է տալիս սլաքը, երբ դուք սեղմում եք, հետախույզը կարծել է, որ ձեր հայացքը խաչից հեռու է: Խնդրում ենք սեղմել խաչը յուրաքանչյուր նոր դիրքում: Դա խաղ է: Բռնե՛ք խաչը։',
    ...
    hi: 'क्रॉस पकड़ो! हमे आपकी मदद की जरूरत है। आई ट्रैकर को अधिक प्रशिक्षण की आवश्यकता है। जैसा कि तीर द्वारा दिखाया गया है, जब आपने क्लिक किया, तो ट्रैकर को लगा कि आपकी नज़र क्रॉस से दूर है। कृपया प्रत्येक नई स्थिति पर क्रॉस पर क्लिक करें। यह एक खेल है। क्रॉस पकड़ो!',
    ...
    ko: '십자가를 잡으라! 우리는 너의 도움이 필요해. 아이트래커는 더 많은 훈련이 필요합니다. 화살표로 표시된 것처럼 클릭하면 추적기는 시선이 십자가에서 멀리 떨어져 있다고 생각했습니다. 각각의 새로운 위치에서 십자가를 클릭하십시오. 그것은 게임이다. 십자가를 잡아라!',
    ...
    ml: 'ക്രോസ് പിടിക്കുക! ഞങ്ങൾക്ക് നിങ്ങളുടെ സഹായം ആവശ്യമാണ്. ഐ ട്രാക്കറിന് കൂടുതൽ പരിശീലനം ആവശ്യമാണ്. അമ്പടയാളം കാണിക്കുന്നത് പോലെ, നിങ്ങൾ ക്ലിക്കുചെയ്യുമ്പോൾ, നിങ്ങളുടെ നോട്ടം കുരിശിൽ നിന്ന് വളരെ അകലെയാണെന്ന് ട്രാക്കർ കരുതി. ഓരോ പുതിയ സ്ഥാനത്തും ദയവായി ക്രോസിൽ ക്ലിക്ക് ചെയ്യുക. അതൊരു കളിയാണ്. കുരിശ് പിടിക്കുക!',
  ...
  RC_nearPointIntro: {
    ...
    ko: '눈 사이의 거리를 측정해보겠습니다. 비디오 이미지를 사용하여 눈을 살펴보세요. 눈 앞에서 얼굴에 수평으로 펜을 대십시오. 오른쪽 및 왼쪽 엄지손가락 손톱을 오른쪽 및 왼쪽 동공의 중심에 맞춥니다. 그런 다음 펜을 화면의 눈금자로 가져와 엄지손가락 사이의 간격을 측정합니다. 왼쪽 엄지손가락을 0에 맞추고 오른쪽 엄지손가락의 위치를 ​​확인하세요. 펜을 내려놓고 그 지점에서 눈금자를 클릭하세요. 마지막으로 확인을 클릭하여 계속하세요.',
    ...
    su: 'Kami bakal ngukur jarak antara panon anjeun. Paké gambar video pikeun lalajo panon anjeun. Tahan pulpén sacara horisontal kana beungeut anjeun di hareupeun panon anjeun. Sejajarkeun kuku jempol katuhu jeung kénca anjeun jeung puseur murid katuhu jeung kénca anjeun. Teras bawa pulpén ka pangawasa dina layar pikeun ngukur jarak antara jempol anjeun. Sejajarkeun jempol kénca anjeun kalayan nol sareng perhatikeun dimana jempol katuhu anjeun. Turunkeun pulpén teras klik pangawasa dina titik éta. Tungtungna, klik OK pikeun neruskeun.',
  ...
  RC_nearPointTitle: {
    ...
    is: 'Mældu vegalengd nemenda',
    id: 'Ukur Jarak Pupil',
    it: 'Misura la Distanza Pupillare',
    ja: '瞳孔間距離の測定',
    kn: 'ಪ್ಯೂಪಿಲ್ಲರಿ ದೂರವನ್ನು ಅಳೆಯಿರಿ',
    ko: '동공 거리 측정',
  ...
  RC_performanceIntro: {
    ...
    lt: 'Prašau netrukdyti. Grafikos piešimas žiniatinklio naršyklės veikimui įvertinti...',
  ...
  RC_privacyCamera: {
    ...
    nl: "WAARBORGEN VAN CAMERA PRIVACY. Er worden geen foto's of video's opgenomen. Elk webcamframe wordt alleen in deze computer gebruikt, uitsluitend om de oog- en blikposities te schatten, en wordt vervolgens binnen 10 seconden gewist. Alleen de oog- en blikposities blijven behouden.",
    'en-UK':
      'ASSURANCE OF CAMERA PRIVACY. No photos or video are recorded. Each webcam frame is used only inside this computer, solely to estimate eye and gaze positions, and then erased, within 10 seconds. Only the eye and gaze positions are retained.',
    ...
    is: 'FYRIR FRÆÐI MYNDAVÉR. Engar myndir eða myndskeið eru tekin upp. Hver vefmyndavélarrammi er aðeins notaður inni í þessari tölvu, eingöngu til að áætla augn- og augnastöður, og síðan eytt innan 10 sekúndna. Aðeins augn- og augnstöður haldast.',
  ...
  RC_viewingBlindSpotCredit: {
    ...
    ro: 'Am îmbunătățit cartografierea punctului mort al lui Li și colab. (2020) prin adăugarea de pâlpâire și control manual.',
  ...
  RC_viewingBlindSpotRejected: {
    ...
    ko: '❌ 죄송합니다. 가장 최근의 왼쪽 및 오른쪽 측정값이 일치하지 않았습니다. 다시 시도하십시오? 한쪽 눈을 감고 있으세요. 십자가에 초점을 맞추고 눈 구석에서 깜박이는 점을 관찰하십시오. 점이 사각지대까지 사라질 때까지 점을 왼쪽과 오른쪽으로 민 다음 스페이스바를 누르세요. 두 눈을 테스트할 때 시청 거리를 유지하십시오.',
    ...
    su: '❌ Punten, pangukuran kénca sareng katuhu panganyarna henteu konsisten. Cobian deui? Tetep hiji panon ditutup. Fokus kana salib sareng ngawas titik kedip-kedip tina sudut panon anjeun. Geser titik ka kénca jeung ka katuhu nepi ka ngaleungit kana blindspot Anjeun, terus pencét SPACE bar. Jaga jarak ningali anjeun nalika anjeun nguji kadua panon.',
  ...
  RC_viewingDistanceIntroLiMethod: {
    ...
    he: 'הֶסבֵּר. לשלב זה, התקרבו, במידת הצורך, כך שאתם לא רחוקים מפי שניים מרוחב המסך. לכל עין יש נקודה עיוורת. אנחנו נמצא את שלך כדי לגלות כמה רחוקה העין שלך מהמסך. תתבקש לסגור או לכסות עין אחת כדי לבודד את השנייה. בזמן שאתה מתמקד בצלב, צפה בנקודה המהבהבת בזווית העין שלך, ולחץ על RETURN כשהיא נעלמת בנקודה העיוורת שלך. בהתאם למרחק הצפייה ולגודל המסך, הנקודה המרצדת בדרך כלל תגיע לנקודה העיוורת שלך לפני שהיא מגיעה לאמצע המסך. אתה תעשה זאת עם כל עין, לסירוגין, עד ששתי המדידות האחרונות יהיו עקביות. נא לשמור על מרחק צפייה בזמן שאתה בודק את שתי העיניים. הערה. אם הנקודה לעולם לא נעלמת, זה אומר שהעין שלך עוקבת אחרי הנקודה, במקום להישאר על הצלב. בדיקה זו מחייבת אותך לפקוח עין על הצלב תוך ניטור הנקודה המרצדת בזווית העין. זה קשה בהתחלה, אבל נעשה קל יותר עם התרגול.',
    ...
    kn: 'ವಿವರಣೆ ಈ ಹಂತಕ್ಕಾಗಿ, ಅಗತ್ಯವಿದ್ದರೆ ಹತ್ತಿರ ಬನ್ನಿ, ಆದ್ದರಿಂದ ನೀವು ಪರದೆಯ ಅಗಲಕ್ಕಿಂತ ಎರಡು ಪಟ್ಟು ಹೆಚ್ಚು ದೂರವಿರುವುದಿಲ್ಲ. ಪ್ರತಿಯೊಂದು ಕಣ್ಣಿಗೂ ಒಂದು ಕುರುಡು ಚುಕ್ಕೆ ಇರುತ್ತದೆ. ನಿಮ್ಮ ಕಣ್ಣು ಪರದೆಯಿಂದ ಎಷ್ಟು ದೂರದಲ್ಲಿದೆ ಎಂಬುದನ್ನು ಕಂಡುಹಿಡಿಯಲು ನಾವು ನಿಮ್ಮದನ್ನು ಕಂಡುಕೊಳ್ಳುತ್ತೇವೆ. ಒಂದು ಕಣ್ಣನ್ನು ಮುಚ್ಚಲು ಅಥವಾ ಇನ್ನೊಂದನ್ನು ಪ್ರತ್ಯೇಕಿಸಲು ಮುಚ್ಚಲು ನಿಮ್ಮನ್ನು ಕೇಳಲಾಗುತ್ತದೆ. ನೀವು ಶಿಲುಬೆಯ ಮೇಲೆ ಕೇಂದ್ರೀಕರಿಸುವಾಗ, ನಿಮ್ಮ ಕಣ್ಣಿನ ಮೂಲೆಯಿಂದ ಮಿನುಗುವ ಬಿಂದುವನ್ನು ವೀಕ್ಷಿಸಿ ಮತ್ತು ಅದು ನಿಮ್ಮ ಬ್ಲೈಂಡ್‌ಸ್ಪಾಟ್‌ನಲ್ಲಿ ಕಣ್ಮರೆಯಾದಾಗ ಹಿಂತಿರುಗಿ ಒತ್ತಿರಿ. ವೀಕ್ಷಣಾ ದೂರ ಮತ್ತು ಪರದೆಯ ಗಾತ್ರವನ್ನು ಅವಲಂಬಿಸಿ, ಮಿನುಗುವ ಚುಕ್ಕೆಯು ಸಾಮಾನ್ಯವಾಗಿ ಪರದೆಯ ಮಧ್ಯಭಾಗಕ್ಕೆ ಬರುವ ಮೊದಲು ನಿಮ್ಮ ಬ್ಲೈಂಡ್‌ಸ್ಪಾಟ್ ಅನ್ನು ತಲುಪುತ್ತದೆ. ಕೊನೆಯ ಎರಡು ಅಳತೆಗಳು ಸ್ಥಿರವಾಗುವವರೆಗೆ ನೀವು ಇದನ್ನು ಪ್ರತಿ ಕಣ್ಣಿನಿಂದ ಪರ್ಯಾಯವಾಗಿ ಮಾಡುತ್ತೀರಿ. ನೀವು ಎರಡೂ ಕಣ್ಣುಗಳನ್ನು ಪರೀಕ್ಷಿಸುವಾಗ ದಯವಿಟ್ಟು ನಿಮ್ಮ ವೀಕ್ಷಣಾ ಅಂತರವನ್ನು ಕಾಪಾಡಿಕೊಳ್ಳಿ. ಸೂಚನೆ. ಚುಕ್ಕೆ ಎಂದಿಗೂ ಕಣ್ಮರೆಯಾಗದಿದ್ದರೆ, ನಿಮ್ಮ ಕಣ್ಣು ಶಿಲುಬೆಯ ಮೇಲೆ ಉಳಿಯುವ ಬದಲು ಚುಕ್ಕೆಯನ್ನು ಅನುಸರಿಸುತ್ತಿದೆ ಎಂದರ್ಥ. ಈ ಪರೀಕ್ಷೆಯು ನಿಮ್ಮ ಕಣ್ಣಿನ ಮೂಲೆಯಲ್ಲಿ ಮಿನುಗುವ ಚುಕ್ಕೆಯನ್ನು ಮೇಲ್ವಿಚಾರಣೆ ಮಾಡುವಾಗ ನಿಮ್ಮ ಕಣ್ಣನ್ನು ಶಿಲುಬೆಯ ಮೇಲೆ ಇರಿಸುವ ಅಗತ್ಯವಿದೆ. ಇದು ಮೊದಲಿಗೆ ಕಷ್ಟ, ಆದರೆ ಅಭ್ಯಾಸದೊಂದಿಗೆ ಸುಲಭವಾಗುತ್ತದೆ.',
    ...
    fa: 'توضیح. برای این مرحله، در صورت لزوم، نزدیک‌تر شوید، بنابراین بیش از دو برابر عرض صفحه نمایش فاصله ندارید. هر چشمی یک نقطه کور دارد. ما چشم شما را پیدا می کنیم تا بفهمیم چشم شما چقدر از صفحه نمایش فاصله دارد. از شما خواسته می شود یک چشم را ببندید یا بپوشانید تا دیگری را جدا کنید. در حالی که روی صلیب تمرکز می کنید، نقطه سوسوزن را از گوشه چشم خود تماشا کنید و هنگامی که در نقطه کور ناپدید شد، RETURN را بزنید. بسته به فاصله مشاهده و اندازه صفحه، نقطه سوسوزن معمولاً قبل از اینکه به وسط صفحه برسد به نقطه کور شما می رسد. شما این کار را با هر چشم، به طور متناوب، تا زمانی که دو اندازه گیری آخر یکسان باشند، انجام خواهید داد. لطفاً هنگام آزمایش هر دو چشم فاصله دید خود را حفظ کنید. توجه داشته باشید. اگر نقطه هرگز ناپدید نشد، به این معنی است که چشم شما به جای اینکه روی صلیب بماند، نقطه را دنبال می کند. این آزمایش به شما نیاز دارد که در حین نظارت بر نقطه سوسو زدن گوشه چشم خود، چشم خود را روی صلیب نگه دارید. این در ابتدا سخت است، اما با تمرین آسان تر می شود.',
