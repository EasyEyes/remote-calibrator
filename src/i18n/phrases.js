...
export const remoteCalibratorPhrases = {
  ...
  RC_distanceTrackingCloseL: {
    ...
    tl: '1. Ipikit ang KALIWA mong mata. (Ito ang kaliwang bahagi ng screen.)\n2. Gamitin ang ▶ arrow key upang i-slide ang kumikislap na tuldok. Habang nakatingin sa krus, subaybayan ang kumukutitap na tuldok sa sulok ng iyong mata, at i-slide ito pakanan at pakaliwa hanggang mawala ito sa iyong blindspot.\n3. Pindutin ang SPACE bar.\nTANDAAN: Itutok ang iyong mata sa krus. Hindi mawawala ang kumikislap na tuldok habang sinusundan ito ng iyong mata.',
  ...
  RC_gazeTrackingIntro: {
    ...
    is: 'SPILAÐU "CATCH THE CROSS!" Nú munum við setja upp augnaráð til að fylgjast með augnstöðu. Haltu andlitinu þínu í myndbandsstraumnum (sjá hér að neðan). Smelltu á miðju krossins, hvar sem hann er. Gakktu úr skugga um að augun séu á því þegar þú smellir á það. Þegar þú smellir á hann færist krossinn á nýjan stað. Smelltu á það á hverjum nýjum stað þar til kvörðun er lokið. Það er leikur. Gríptu krossinn!',
  ...
  RC_gazeTrackingNudge: {
    ...
    ja: 'クロスをキャッチ!君の力が必要なんだ。アイトラッカーにはさらなるトレーニングが必要です。矢印で示されているように、クリックすると、トラッカーはあなたの視線が十字架から遠く離れていると判断しました。新しい位置ごとにバツ印をクリックしてください。それはゲームです。クロスをキャッチ！',
  ...
  RC_requestCamera: {
    ...
    hy: 'Շարունակելու համար այս ուսումնասիրությանը անհրաժեշտ է ձեր թույլտվությունը՝ տեսախցիկը օգտագործելու համար: ',
  ...
  RC_viewingBlindSpotRejected: {
    ...
    bg: '❌ За съжаление последните леви и десни измервания не съответстват. Опитай пак? Дръж едното си око затворено. Фокусирайте се върху кръста и наблюдавайте мигащата точка с ъгъла на окото си. Плъзнете точката наляво и надясно, докато изчезне в сляпото ви петно, след което натиснете ИНТЕРВАЛ. Поддържайте разстоянието на гледане, докато тествате и двете очи.',
    'zh-CN':
