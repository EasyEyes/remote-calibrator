...
export const remoteCalibratorPhrases = {
  ...
  RC_PutYourGlassesBackOn: {
    'en-US': 'Put your glasses back on.',
    ar: 'ضع نظاراتك مرة أخرى.',
    hy: 'Put your glasses back on.',
    bg: 'Сложете обратно очилата си.',
    'zh-CN': '请重新戴上眼镜。',
    'zh-HK': '請重新戴上眼鏡。',
    hr: 'Stavite naočale natrag.',
    cs: 'Nasaďte si brýle zpět.',
    da: 'Tag dine briller på igen.',
    nl: 'Zet uw bril weer op.',
    'en-UK': 'Put your glasses back on.',
    fi: 'Laita silmälasisi takaisin päähän.',
    fr: 'Remettez vos lunettes.',
    de: 'Setzen Sie Ihre Brille wieder auf.',
    el: 'Βάλτε τα γυαλιά σας πίσω.',
    he: 'הרכיבו את המשקפיים שלכם בחזרה.',
    hi: 'अपना चश्मा वापस लगाएं।',
    hu: 'Tegye vissza a szemüvegét.',
    is: 'Settu gleraugun þín aftur á.',
    id: 'Kenakan kembali kacamata Anda.',
    it: 'Rimettiti gli occhiali.',
    ja: 'メガネをかけ直してください。',
    kn: 'ನಿಮ್ಮ ಕನ್ನಡಕವನ್ನು ಮತ್ತೆ ಹಾಕಿ.',
    ko: '안경을 다시 쓰세요.',
    lt: 'Vėl užsidėkite akinius.',
    ms: 'Pakai semula cermin mata anda.',
    ml: 'നിങ്ങളുടെ കണ്ണട തിരികെ ധരിക്കുക.',
    no: 'Sett på deg brillene igjen.',
    fa: 'عینک خود را دوباره بزنید.',
    pl: 'Załóż okulary z powrotem.',
    pt: 'Coloque seus óculos de volta.',
    ro: 'Puneți-vă ochelarii la loc.',
    ru: 'Наденьте очки обратно.',
    sr: 'Ставите наочаре поново.',
    es: 'Vuelva a ponerse las gafas.',
    sw: 'Vaa miwani yako tena.',
    sv: 'Sätt på dig glasögonen igen.',
    tl: 'Isuot muli ang iyong salamin.',
    tr: 'Gözlüğünüzü tekrar takın.',
    ur: 'اپنا چشمہ واپس لگائیں۔',
  },
  T_proceed: {
    'en-US': 'Proceed',
    ar: 'تابع',
